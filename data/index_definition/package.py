#!/usr/bin/env python3
"""Package index_definition data directories into tar archives.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Package index_definition data directories into tar archives")
