...
_GEO_MORE_PROOF_RICH = [
    Template(
        ...
        slots={
            "P1": E(lambda rng: rng.choice(_PTS), n=9),
            "P2": E(lambda rng: rng.choice(_PTS), n=9),
            "P3": E(lambda rng: rng.choice(_PTS), n=9),
            "P4": E(lambda rng: rng.choice(_PTS), n=9),
        },
    ),
    Template(
        ...
        slots={
            "P1": E(lambda rng: rng.choice(_TRI_VERTS), n=9),
            "Q1": E(lambda rng: rng.choice(_TRI_VERTS), n=9),
            "R1": E(lambda rng: rng.choice(_TRI_VERTS), n=9),
            "P2": E(lambda rng: rng.choice(_TRI_VERTS), n=9),
            "Q2": E(lambda rng: rng.choice(_TRI_VERTS), n=9),
            "R2": E(lambda rng: rng.choice(_TRI_VERTS), n=9),
        },
    ),
]
