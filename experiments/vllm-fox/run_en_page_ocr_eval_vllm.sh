...
# Fox Benchmark - English Page OCR Evaluation with vLLM
# Usage: ./run_en_page_ocr_eval_vllm.sh

set -e

echo "========================================="
echo "Fox Benchmark - English Page OCR Evaluation (vLLM)"
echo "========================================="
...
OUTPUT_FILE="./results_qwen25_3b_en_page_ocr_vllm.json"
...
# OUTPUT_FILE="./results_qwen25_7b_en_page_ocr_vllm.json"

# =============================================================================
# DATA PATHS
# =============================================================================
GT_FILE="./focus_benchmark_test/en_page_ocr.json"
