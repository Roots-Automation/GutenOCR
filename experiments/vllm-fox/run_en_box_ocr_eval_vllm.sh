...
# Fox Benchmark - English Box OCR Evaluation with vLLM
# Usage: ./run_en_box_ocr_eval_vllm.sh

set -e

echo "========================================="
echo "Fox Benchmark - English Box OCR Evaluation (vLLM)"
echo "========================================="
...
OUTPUT_FILE="./results_qwen25_3b_en_box_ocr_vllm.json"
...
# OUTPUT_FILE="./results_qwen25_7b_en_box_ocr_vllm.json"

# =============================================================================
# DATA PATHS
# =============================================================================
GT_FILE="./focus_benchmark_test/en_box_ocr.json"
